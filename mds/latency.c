 ...
 *
 * Armed with EMACS.
 * Time-stamp: <2019-08-19 17:44:28 macan>
 *
...
#ifndef __GK_LATENCY_STAT_C__
#define __GK_LATENCY_STAT_C__

/* if GK_LATENCY_STAT defined, we do latency stat */
#ifdef GK_LATENCY_STAT
...
void mds_cb_latency(void *arg)
{
    ...
    if (!p) {
        gk_err(xnet, "xzalloc() cb_latency array failed\n");
        return;
    }
