 ...
 *
 * Armed with EMACS.
 * Time-stamp: <2019-09-29 16:41:27 macan>
 *
...
struct mds_mds_prof
{
    atomic64_t ns_ins_collisions;
    atomic64_t ns_lkp_collisions;
    atomic64_t loop_fwd;
    atomic64_t paused_mreq;
};
...
struct mds_prof
{
    ...
    struct mds_storage_prof storage;
